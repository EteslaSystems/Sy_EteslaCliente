            ...
            <tr>
                <?php if(!is_null($paneles)): ?>
                    ...
                    <td id="imgLogoPanel" align="center" style="border: none;">
                        <img style="width: 140px; height: 85px;" src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('/img/equipos/logos/panel/' . $image)))); ?>">
                        <p style="text-align:center; font-size:10px; margin-top:-15px;">
                            <strong><?php echo e($paneles['vMarca']); ?></strong>
                        </p>
                    </td>
                <?php endif; ?>
                <?php if(!is_null($inversores)): ?>
                    ...
                    <td id="imgLogoInversor" align="center" style="border: none;">
                        <img style="width: 140px; height: 85px;" src="data:image/jpg;base64,<?php echo e(base64_encode(file_get_contents(public_path('/img/equipos/logos/inversor/' . $image)))); ?>">
                        <p style="text-align:center; font-size:10px; margin-top:-15px;">
                            <strong><?php echo e($inversores['vMarca']); ?></strong>
                        </p>
                    </td>
                <?php endif; ?>
                <?php if(!is_null($estructura["_estructuras"])): ?>
                    ...
                    <td id="imgLogoEstructuras" align="center" style="border: none;">
                        <img style="width: 120px; height: 85px;" src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('/img/equipos/logos/estructura/' . $image)))); ?>">
                        <p style="text-align:center; font-size:10px; margin-top:-15px;">
                            <strong><?php echo e($estructura["_estructuras"]['vMarca']); ?></strong>
                        </p>
                    </td>
                <?php endif; ?>
            </tr>
            ...
            <tr>
                <td style="padding-right: 60px;">
                    <div name="ANCE">
                        <div style="margin-left:20px;">
                            <img height="90px" width="12%" style="margin-top:15px;" src="data:image/jpg;base64,<?php echo e(base64_encode(file_get_contents(public_path('/img/pdf/ance.jpg')))); ?>">
                        </div>
                ...
                <td>
                    <div style="margin-top:-50px; margin-left:480px;">
                        <div style="margin-left:-305px; margin-top:60px;">
                            <img height="100px" width="20%" style="margin-left:-220px; margin-bottom:20px;" src="data:image/jpg;base64,<?php echo e(base64_encode(file_get_contents(public_path('/img/pdf/wwf.jpg')))); ?>">
                        </div>
                ...
                <td>
                    <div style="margin-left:-266px;">
                        <div>
                           <img height="50px" width="27%" style="margin-left:15px;" src="data:image/jpg;base64,<?php echo e(base64_encode(file_get_contents(public_path('/img/pdf/csolar.jpg')))); ?>"> 
                        </div>
                        <div>

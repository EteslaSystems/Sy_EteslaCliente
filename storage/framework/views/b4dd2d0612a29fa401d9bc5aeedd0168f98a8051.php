...
<body>
    ...
    <div class="container-fluid" style="border-top: 10px solid #5576F2;">
        ...
        <div id="recuadroFlotante">
            <div>
                <p id="nombreCliente" class="textIncProupesta"><strong>Cliente: </strong><?php echo e($cliente["vNombrePersona"] ." ". $cliente["vPrimerApellido"]); ?></p>
            ...
            <tr>
                <?php if(!is_null($paneles)): ?>
                    <td id="imgLogoPanel" align="center" style="border: none;">
                        <img style="width: 140px; height: 78px;" src="https://drive.google.com/uc?export=view&id=<?php echo e($paneles['imgRuta']); ?>">
                    </td>
                <?php endif; ?>
                <?php if(!is_null($inversores)): ?>
                ...
                <?php if(!is_null($estructura["_estructuras"])): ?>
                    <td id="imgLogoEstructuras" align="center" style="border: none;">
                        <img style="width: 120px; height: 78px;" src="https://drive.google.com/uc?export=view&id=<?php echo e($estructura['_estructuras']['imgRuta']); ?>">
                    </td>
                <?php endif; ?>
            </tr>
        </table>

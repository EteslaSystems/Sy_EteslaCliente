...
<body>
    ...
    <div class="container-fluid" style="border-top: 10px solid #5576F2;">
        ...
        <div id="recuadroFlotante">
            <div>
                <p id="nombreCliente" class="textIncProupesta"><?php echo e($cliente["vNombrePersona"] ." ". $cliente["vPrimerApellido"] ." ". $cliente["vSegundoApellido"]); ?></p>
                <p id="direccionCliente" class="textIncProupesta"><?php echo e($cliente["vCalle"] ." ". $cliente["vMunicipio"] ." ". $cliente["vEstado"]); ?></p>

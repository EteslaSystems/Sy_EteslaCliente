        ...
        <table class="table-contenedor" style="margin-top: 35px;">
            <tr>
                ...
                <td>
                    <div>
                        <div style="margin-left:32px;">
                            <img style="width: 140px; height: 78px;" src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('/img/equipos/logos/panel/Axitec.png')))); ?>">
                        </div>
                        <div style="margin-top: -50px; margin-left:80px;">
...
</html><?php /**PATH C:\xampp\htdocs\Sy_EteslaCliente\resources\views/PDFTemplates/machotes/individual.blade.php ENDPATH**/ ?>
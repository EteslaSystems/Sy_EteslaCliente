            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
                    <li class="nav-item active">
                        <a class="nav-link" id="navOption" href="<?php echo $__env->yieldContent('rutaInicioUser'); ?>">Inicio<span class="sr-only">(current)</span></a>
                    </li>
...
<?php echo $__env->make('template/head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\EteslaPanelesSolares\resources\views/template/body.blade.php ENDPATH**/ ?>
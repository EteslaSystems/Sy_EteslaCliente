...
<body>
    ...
    <p class="text-center subtitulo">Este es un minitexto ifijfoifeaifjofoi;fijoejajioefjaefioajsfiojaseiofjaeoisfjaoij</p>
    <div class="container">
        <h3 class="text-center" style="text-decoration: underline;">Propuesta solar</h3>
        <div class="jumbotron jumbotron-fluid">
            <h1 id="nombreCliente" class="text-center">Nombre del cliente</h1>
            <p id="direccionCliente" class="text-center subtitulo">Direccion del cliente</p>
        </div>

            ...
            <section class="col-12 col-sm-6 col-md-3">
                <form method="post" class="fmc form-container">
                    ...
                    <div class="form-group">
                        ...
                        <a href="<?php echo e(('/registro')); ?>" align="center"><p>Registrate</p></a>
                        <div class="row justify-content-center">
...
<?php echo $__env->make('authentication/templateAuth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Sy_EteslaCliente\resources\views/authentication/login.blade.php ENDPATH**/ ?>
            ...
            <div class="form-group row">
                <div class="col-sm-12">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control form-control-lg" id="inpSearchClient" list="colores" placeholder="Busca un clientesssss">
                        <datalist id="colores">
                ...
                <div class="row">
                    <div class="col-sm">
                        <div class="form-group">
                            ...
                            <div class="col-lg-12" id="lblNombreCliente">
                                <label>Nombre completo del cliente (con apellidos)</label>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm">

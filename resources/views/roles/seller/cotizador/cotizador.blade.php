                ...
                <div class="col-sm-12">
                    <div class="input-group">
                        ...
                        <datalist id="colores">
                            ...
                            <option value="{{$cliente->vNombrePersona}}&nbsp;{{$cliente->vPrimerApellido}}&nbsp;{{$cliente->vSegundoApellido}}"></option>
                            @endforeach
                        </datalist>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col col-4">
                <div class="card border-light text-center" style="border: none;">
                    <div id="lblNombreCliente" class="card-body" style="background-color: #e9ecef;">

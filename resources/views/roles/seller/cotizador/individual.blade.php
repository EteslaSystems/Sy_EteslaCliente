                    ...
                    <div class="card-body row" style="border-left: 3px solid #F9FE39; border-right: 3px solid #F9FE39; border-top: 3px solid #F9FE39; border-bottom: 3px solid #F9FE39;">
                        <div class="col">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="1" id="chbMO" checked>
                                <label class="form-check-label" for="chbMO" style="color: #888;">Mano de obra</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="1" id="chbOtros" checked>
                                <label class="form-check-label" for="chbOtros" style="color: #888;">Otros</label>
                            </div>
                        </div>
                        <div class="col col-sm-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="1" id="chbFletes" checked>
                                <label class="form-check-label" for="chbFletes" style="color: #888;">Fletes</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="1" id="chbViaticos" checked>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body row">
                                            <div class="col">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="1" id="chbPasaje" checked>
                                                    <label class="form-check-label" for="chbPasaje" style="color: #888;">Pasaje</label>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="1" id="chbHospedaje" checked>
                                                    <label class="form-check-label" for="chbHospedaje" style="color: #888;">Hospedaje</label>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="1" id="chbComida" checked>

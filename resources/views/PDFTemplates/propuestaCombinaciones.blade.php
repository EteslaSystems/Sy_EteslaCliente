            ...
            <table class="table-costos-proyecto">
                ...
                <tbody>
                    ...
                    <tr style="background-color: #E8E8E8;">
                        ...
                        <td></td>
                        <td style="width:10%;"></td>
                        <td id="subtotalSinIVAUSD" align="center">${{ $propuesta["totales"]["precio"] }} USD</td>
                        <td id="subtotalSinIVAMXN" align="center">${{ $propuesta["totales"]["precioMasIVA"] }} MXN</td>
                    </tr>
                    <tr style="background-color: #E8E8E8;">
                        <td><strong>Total con IVA</strong></td>
                        <td></td>
                        <td style="width:10%;"></td>
                        <td id="totalConIVAUSD" align="center">${{ $propuesta["totales"]["precioMXNSinIVA"] }} USD</td>
                        <td id="totalConIVAMXN" align="center">${{ $propuesta["totales"]["precioMXNConIVA"] }} MXN</td>
                    </tr>
                </tbody>
            </table>
        </div>
                ...
                <td style="padding-right: 60px;">
                    ...
                    <div>
                        ...
                        <div style="margin-top: -50px; margin-left:98px;">
                            ...
                            <p class="text-inferior-pag1-secundary" style="margin-top:-9px;">{{ $propuesta["paneles"]["potenciaReal"] }} KwP</p>
                        </div>
                    </div>
                    <div>
                        <div style="margin-left:20px;">
                        ...
                        <div style="margin-top: -50px; margin-left:98px;">
                            ...
                            <p class="text-inferior-pag1-secundary" style="margin-top:-11px;">{{ $propuesta["power"]["porcentajePotencia"] }}%</p>
                        </div>
                    </div>
                </td>
                <td>

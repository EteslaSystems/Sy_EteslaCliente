...
<body>
    ...
    <div class="container-fluid" style="border-top: 10px solid #5576F2;">
        ...
        <div id="recuadroFlotante">
            <div>
                <p id="nombreCliente" class="textIncProupesta">{{ $cliente["vNombrePersona"] ." ". $cliente["vPrimerApellido"] ." ". $cliente["vSegundoApellido"] }}</p>
                <p id="direccionCliente" class="textIncProupesta">{{ $cliente["vCalle"] ." ". $cliente["vMunicipio"] ." ". $cliente["vEstado"] }}</p>
        ...
        <div class="garantias">
            @if(!is_null($paneles))
                <p>Garantia en el panel <strong>{{ $paneles["vMarca"] }}</strong> con {{ $paneles["vGarantia"] }} años de garantia</p>
            @endif
            @if(!is_null($inversores))

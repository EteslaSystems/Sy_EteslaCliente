...
<style type="text/css">
    ...
    *{
    ...
    .marca-de-agua{
        background-image: url('data:image/png;base64,{{ base64_encode(file_get_contents(public_path('/img/etesla-logo.png'))) }}');
            ...
            <table id="nota-costo-watt" class="table-comparative" style="margin-top:70px;">
                <tr>
                    <td style="background-color:#9AC5E7;">
                        <p style="font-size:13px; font-weight:bold;">NOTA IMPORTANTE</p>
                    </td>
                </tr>
                <tr>
                    <td>

        ...
        <table class="table-contenedor">
            <tr>
                <td id="imgLogoPanel" align="center" style="border: none;">
                    <img style="width:140px; height:97px;" src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('/img/equipos/logos/panel/Canadian.png'))) }}">
                </td>
                <td id="imgLogoInversor" align="center" style="border: none;">
                    <img style="width:140px; height:97px;" src="data:image/jpg;base64,{{ base64_encode(file_get_contents(public_path('/img/equipos/logos/inversor/APSystem.jpg'))) }}">
                </td>
                <td id="imgLogoInversor" align="center" style="border: none;">
                    <img style="width:140px; height:97px;" src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('/img/equipos/logos/estructura/Everest.png'))) }}">
                </td>
            </tr>
        </table>
        ...
        <div class="div-contenedor">
            ...
            <table>
                <tr name="div-panel">
                    <td name="img-equipo" width="30%">
                        <div class="div-contenedor" style="margin-top:-40px; margin-left:-23px;">
                            <img height="195px" width="187px" src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('/img/equipos/instrumentos/panel/Axitec.png'))) }}">
                        </div>
                    </td>
                ...
                <tr name="div-inversor">
                    ...
                    <td name="img-equipo" width="30%">
                        <div class="div-contenedor">
                            <img height="195px" width="187px" style="margin-top:-20px;" src="data:image/jpg;base64,{{ base64_encode(file_get_contents(public_path('/img/equipos/instrumentos/inversor/Fronius Solar.jpg'))) }}">
                        </div>
                    </td>
                </tr>
            </table>

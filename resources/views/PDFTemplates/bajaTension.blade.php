    ...
    <div class="container-table">
        ...
        <table class="table-costos-proyecto">
            ...
            <tr>
                ...
                @endif
                <td align="center"><img
                            src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('/img/pdf/banderas/estados-unidos.png'))) }}"/>
                </td>
                <td align="center"><img
                            src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('/img/pdf/banderas/mexico.png'))) }}"/>
                </td>
            </tr>
            <tr style="background-color: #E8E8E8;">
                ...
                @if($descuento["porcentaje"] > 0)
                    <td id="tdTotalAntesDeDescuento"
                        style="border-right:solid #2593F0; border-left:solid #2593F0; border-bottom:solid #2593F0;">
    ...
    <table class="table-contenedor" style="margin-top:20px;">
        <tr>
            <td id="imgLogoPanel" align="center" style="border: none;">
                ...
                <img style="width: 140px; height: 67px;"
        ...
        <tr>
            ...
            <td align="center">
                ...
                <div style="margin-right:20px;">
                    ...
                    <h2 style="color:#3333FF; margin-left:-50px;">{{ $power["generacion"]["promeDGeneracionBimestral"] }} kWh</h2>
                </div>
            </td>
        </tr>
    </table>
        ...
        <tr>
            ...
            <td align="center">
                <div style="margin-left:-55px; margin-right:55px;">
                    <p style="text-align: center; font-weight: bold;">EL SISTEMA FOTOVOLTAICO PRESENTADO EN ESTA PROPUESTA, EQUIVALE A <strong style="color:#8AADCE;">{{ $power["objImpactoAmbiental"]["numeroArboles"] }}</strong> ÁRBOLES PLANTADOS AL AÑO.</p>
